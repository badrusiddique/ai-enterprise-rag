...
These are the patterns you'd use in a real agent, not just a Q&A bot.
...
| Chat model             | `qwen3` via Ollama — supports thinking + tool use         |
...
Same 20 films as the base app, grouped by director. Descriptions in this version include director, year, and lead cast — richer context for the LLM to reason over.
